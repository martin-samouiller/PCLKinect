...
private slots:
    void on_comboBox_FiltersType_currentIndexChanged(const QString &arg1);

    void on_btn_saveCloud_clicked();

    void on_comboBox_Clouds_currentIndexChanged(const QString &arg1);
